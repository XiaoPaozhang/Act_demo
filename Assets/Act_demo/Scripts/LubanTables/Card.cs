...
public sealed partial class Card : Luban.BeanBase
{
    public Card(JSONNode _buf) 
    {
        ...
        { if(!_buf["AssociatedMinoinId"].IsNumber) { throw new SerializationException(); }  AssociatedMinoinId = _buf["AssociatedMinoinId"]; }
    }
    ...
    /// 关联的随从编号
    /// </summary>
    public readonly int AssociatedMinoinId;
    ...
    public override string ToString()
    {
        ...
        + "star:" + Star + ","
        + "des:" + Des + ","
        + "AssociatedMinoinId:" + AssociatedMinoinId + ","
        + "}";
    }
}
